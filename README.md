...
https://github.com/guilhermeonrails/olimpiadas-github
https://github.com/guilhermeonrails/olimpiadas

**Vamos juntos criar a maior base de dados de atletas do Brasil!**

**Dicas**
* Usar o Google AI Studio para conseguir funções avançadas e gratuitas do Gemini
* Class são referencias para o CSS
* ID são referencias para o JS
* document em JS é um objeto que fornece acesso ao HTML
* Use o Gemini para obter explicação sobre o codigo com a tag '''js codigo '''
